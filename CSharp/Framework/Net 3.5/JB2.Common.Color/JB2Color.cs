...
namespace JB2.Common
{
    public class JB2Color
    {
        ...
        {
            int r = JB2.Common.ThreadSafeRandom.ThisThreadsRandom.Next(0,255);
            int g = JB2.Common.ThreadSafeRandom.ThisThreadsRandom.Next(0, 255);
            int b = JB2.Common.ThreadSafeRandom.ThisThreadsRandom.Next(0, 255);

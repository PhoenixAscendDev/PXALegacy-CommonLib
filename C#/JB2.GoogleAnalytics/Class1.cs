...
namespace JB2
{
    public static class GoogleAnalytics
    {
       ...
       // static readonly string _javascriptTracking = "<script>{0}</script>";
        ...
        public static string TrackingJavascript
        {
            get
            {
        ...
        public static string GetTrackingJavascript(string trackingID)
        {

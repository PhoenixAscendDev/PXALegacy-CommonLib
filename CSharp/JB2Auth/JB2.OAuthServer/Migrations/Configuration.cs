namespace JB2.OAuth.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<JB2.OAuth.OAuthDbContext>
    {
        ...
        protected override void Seed(JB2.OAuth.OAuthDbContext context)
        {

...
namespace JB2.Common.Log
{
    ...
    {
        public static void Log(this ILoggerAsync logger, Enum.LogServerityType serverity, string message)
        {
            logger.Log(LogEntry.NewLogEntry(serverity, message));
        }

        public static void Log(this ILoggerAsync logger, Enum.LogServerityType serverity, Exception exception)
        {
            logger.Log(LogEntry.NewLogEntry(serverity, exception));
        }

        public static void LogInformation(this ILoggerAsync logger, string message)
        {
            logger.Log(LogEntry.NewLogEntry(Enum.LogServerityType.Informational, message));
        }

        public static void LogError(this ILoggerAsync logger, Exception ex)
        {
            logger.Log(LogEntry.NewLogEntry(Enum.LogServerityType.Error, ex));
        }

        public static void LogDebug(this ILoggerAsync logger, string message)
        {
    ...
    {
        public static void LogIt(this Exception ex, ILoggerAsync logger, Enum.LogServerityType serverity)
        {
            logger.Log(serverity, ex);
        }

        public static void LogIt(this Exception ex, ILoggerAsync logger)
        {
            logger.LogError(ex);
        }
        // More methods here.

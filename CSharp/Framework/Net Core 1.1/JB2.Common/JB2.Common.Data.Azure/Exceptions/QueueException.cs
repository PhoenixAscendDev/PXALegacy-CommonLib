...
{
    public class StorageQueueException : System.ApplicationException
    {
        private string stackTraceOverride;
        protected Microsoft.WindowsAzure.Storage.CloudStorageAccount _account;
        protected string _tableName;

        public StorageQueueException(string message, Microsoft.WindowsAzure.Storage.CloudStorageAccount account,string queueName, Exception innerException)
            : base(message)
        {
            _tableName = queueName;
            _account = account;
        }

        public StorageQueueException(string message, Exception innerException)
